...
set(MSG_I_FLAGS "-Iassignment0:/home/lorne/ros_wkspace_asgnX/src/assignment0/assignment0/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/lorne/ros_wkspace_asgnX/src/assignment0/assignment0/msg/TwoInt.msg" NAME_WE)
add_custom_target(_assignment0_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "assignment0" "/home/lorne/ros_wkspace_asgnX/src/assignment0/assignment0/msg/TwoInt.msg" ""
)
...
_generate_msg_cpp(assignment0
  "/home/lorne/ros_wkspace_asgnX/src/assignment0/assignment0/msg/TwoInt.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/assignment0)
  install(CODE "execute_process(COMMAND \"/usr/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/assignment0\")")
  # install generated code
  install(
